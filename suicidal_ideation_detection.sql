...
--
-- Database: `suicidal_ideation_detection`
--
CREATE DATABASE IF NOT EXISTS `suicidal_ideation_detection` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `suicidal_ideation_detection`;
...
(1, 'Mohan', 'Mohan123@gmail.com', 'Mohan', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(2, 'Manjunath', 'tmksmanju19@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_detecting_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_detecting_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Text_Id` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_detecting_type`
--

INSERT INTO `remote_user_detecting_type` (`id`, `Text_Id`, `Message_Text`, `Prediction`) VALUES
(1, '430', 'I''m just doneI have vaginismus and I lost faith in friendship. I don''t care about life anymore. I would like to die', 'Suicide'),
(2, '431', 'My crush just asked me out. Then she told me it was a joke.\r\n\r\nGuys, please donâ€™t do this. Itâ€™s cruel and unnecessary. Itâ€™s okay if you donâ€™t like someone that likes you, but donâ€™t play with their emotions. Please.\r\n', 'Non-Suicide'),
(3, '467', 'My teacher played some Christmas songs today. jUST BECAUSE IT STARTED SNOWING, DOES NOT MEAN YOU GET TO JUMP INTO THE CHRISTMAS SPIRIT. KEEP IT SPOOKY, SPOOKY!! SHUT UP MARIA CURRY', 'Non-Suicide'),
(4, '2900', '97 Hydrocodoneyou know i''d never hurt you on purpose, right?\r\n\r\nyou know i love you like family, right?\r\n\r\nyou mean the world to me.\r\n\r\nbut it hurts too much.\r\n\r\ni''m sorry.', 'Suicide'),
(5, '4327', 'Does anyone may know what guitar is used in this vid: https://youtu.be/eHS5V7Q3n0U\r\n\r\nFiller filler filler filler filler filler filler', 'Non-Suicide'),
(6, '230', 'my happiness, my passions my all of it. I don''t think I could ever begin to repay him. With everything he''s done...I''m overjoyed. And I tell him all of this everyday and he takes it with such modesty, or "I know I''m all these things, but so are you" He knows me, he knows who I am, he''s the first per', 'Suicide'),
(7, '269', 'This is all great until you realize that a lot of these companies only do this amid a protest that pertains to race. Iâ€™ve never seen this rush for diversity when instances are â€œnormalâ€ (normal meaning not a huge public outcry for racial reform). \r\n\r\nMaybe Iâ€™m reading too far into it but itâ€', 'Non-Suicide');
...
(13, 'Naive Bayes', '87.35000000000001'),
(14, 'SVM', '89.3'),
(15, 'Logistic Regression', '90.9'),
(16, 'Decision Tree Classifier', '83.8'),
(17, 'Random Forest Classifier', '85.55'),
(18, 'SGD Classifier', '88.44999999999999');
...
(17, 'Suicide', '42.857142857142854'),
(18, 'Non-Suicide', '57.14285714285714');
