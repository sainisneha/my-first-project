"""suicidal_ideation_detection URL Configuration
...
from suicidal_ideation_detection import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Message_Text_Type/$', remoteuser.Predict_Message_Text_Type, name="Predict_Message_Text_Type"),
    ...
    url(r'^View_Message_Text_Type_Ratio/$', serviceprovider.View_Message_Text_Type_Ratio, name="View_Message_Text_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Message_Text_Type/$', serviceprovider.View_Prediction_Of_Message_Text_Type, name="View_Prediction_Of_Message_Text_Type"),
